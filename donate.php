...
#myBtn:hover {
  ...
  <nav class="navbar navbar-inverse" style="background-color:steelblue;">
    ...
    <li><a href="disscussion.php" style="color:white;font-weight:bold;font-size:18px;">Discussion</a></li>
    ...
    <li class="active"><a href="donate.php" style="color:white;font-weight:bold;font-size:18px;">Donate Now</a></li>
