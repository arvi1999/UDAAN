...
#myBtn:hover {
  ...
  <body>
    ...
    <div class="container-fluid" style="background-color: grey">
        ...
        <br/>
        <p>A fashion show is to be organised where the victims of acid attack will do the ramp walk in the outfits designed by famous artists.This event aims to build the self confidence among these victims so that they can face the society with full confidence.It also aims to bring a change in the perception of people's mindset about these victims. </p>
        <br/>
        <h1>Venue</h1><hr/>
        <p>progressive point, fashion complex, Draupadi nagar south Delhi</p>

        <br/>
        <h1>Timings</h1><hr/>
        <p> Tuesday,27-march-2018,5:30 pm +GST</p>
        <br/>
        </script>
<!--get path-->
<h1 id="demo">click the button to get path</h1>

<button type=button class="btn btn-primary"onclick="getLocation()">show path</button></p>
...
function showPosition(position) {
    ...
    var latlon2 =new google.maps.LatLng(21.240810,81.660488);
    var mapCanvas = document.getElementById("map");
  var mapOptions = {center: latlon1, zoom: 4};
 ...
 <script src="https://maps.google.com/maps/api/js?key=AIzaSyB80-KiFMuiTpxSW7d5AMbTzTpLzhZlz5U"></script>  
