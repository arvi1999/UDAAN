...
#myBtn:hover {
  ...
  <body>
	...
	<div class="container-fluid" style="background-color: grey">
		...
		<br/>
		<p>The Students of <a href="http://www.nitrr.ac.in/">NIT Raipur</a>Dramatics club<a href="https://www.facebook.com/RangmanchNITRR/"> "Rangmanch"</a> will perform a street play(Nukkad Natak) to create social awareness among the people on the Domestic violence </p>
		<br/>
		<h1>Venue</h1><hr/>
		<p>Telibandha Talab, Raipur, Chhattisgarh 492001
Marine Drive, Raipur, Address</p>

		<br/>
		<h1>Timings</h1><hr/>
		<p> Tuesday,20-march-2018,5:30 pm +GST</p>
		<br/>
		</script>
<!--get path-->
